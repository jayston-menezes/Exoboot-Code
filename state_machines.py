...
class StandingPerturbationResponse(HighLevelController):
    ...
    def step(self, read_only):
        ...
        if self.slip_ctrl_timer.check():
            ...
            self.control_state = constants.ControlState.StandingState
            ...
            self.control_state = constants.ControlState.SlipState
        else:
...
class StanceSwingReeloutReelinStateMachine(HighLevelController):
    ...
    def step(self, read_only=False):
        ...
        if self.just_starting:
            ...
            did_controllers_switch = True
            self.control_state = constants.ControlState.ReelOutState
            ...
            self.control_state = constants.ControlState.ReelInState
        ...
        if not read_only:
            ...
            if self.config.STANCE_CONTROL_STYLE == config_util.StanceCtrlStyle.VIRTUALNEUROMUSCULARCONTROLLER and self.exo.data.controller != constants.ControllerUsed.VirtualNeuromusuclarController:
